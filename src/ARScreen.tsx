...
const FILTERS = [
  { name: 'بحيرات الملح',   src: '/backgrounds/بحيرات الملح .png',   info: 'بحيرات الملح، اللي فيها نسبة ملوحة عالية جدًا بتخلي الجسم يطفو بسهولة، وده بيساعد على الاسترخاء وتقليل التوتر وتحسين الدورة الدموية.' },
  { name: 'بحيرات الملح ٢', src: '/backgrounds/بحيرات الملح.png',    info: 'بحيرات الملح، اللي فيها نسبة ملوحة عالية جدًا بتخلي الجسم يطفو بسهولة، وده بيساعد على الاسترخاء وتقليل التوتر وتحسين الدورة الدموية.' },
  { name: 'جبل الدكرور',    src: '/backgrounds/جبل الدكرور.png',     info: 'جبل الدكرور معروف جدًا بعلاج الدفن في الرمل، وده بيتم فيه إن الشخص يندفن في الرمل السخن من 15 لـ 30 دقيقة في الصيف. العلاج ده بيُعتقد إنه بيساعد في مشاكل زي الروماتيزم، وآلام المفاصل، ومشاكل العمود الفقري، وكمان بعض أمراض الجلد. بعد الجلسة، الشخص بيرتاح في خيمة، وبيشرب مشروبات دافية زي الحلبة، وبيتعمل له مساج بزيت الزيتون علشان يرجع حرارة جسمه ويحسّن الدورة الدموية.' },
  { name: 'جبل الدكرور 2',  src: '/backgrounds/جبل دكرور.png',       info: 'جبل الدكرور معروف جدًا بعلاج الدفن في الرمل، وده بيتم فيه إن الشخص يندفن في الرمل السخن من 15 لـ 30 دقيقة في الصيف. العلاج ده بيُعتقد إنه بيساعد في مشاكل زي الروماتيزم، وآلام المفاصل، ومشاكل العمود الفقري، وكمان بعض أمراض الجلد. بعد الجلسة، الشخص بيرتاح في خيمة، وبيشرب مشروبات دافية زي الحلبة، وبيتعمل له مساج بزيت الزيتون علشان يرجع حرارة جسمه ويحسّن الدورة الدموية.' },
  { name: 'حمام فرعون',     src: '/backgrounds/حمام فرعون.png',      info: 'المكان عبارة عن كهف في جبل بيطلع منه مياه كبريتية سخنة جدًا، ودرجة حرارتها بتوصل لحوالي 55 درجة، وبعد كده بتنزل على البحر مباشرة. الكهف فيه فتحات صخرية شبه الساونا، وده بيعمل جو طبيعي مناسب للعلاج. المياه دي غنية بالكبريت، وبتُستخدم في علاج مشاكل زي الروماتيزم، وآلام المفاصل، وخشونة الركبة، وكمان مشاكل العمود الفقري.' },
  { name: 'حمام موسى',      src: '/backgrounds/حمام موسي.png',       info: 'حمام موسى يتميز بوجود 5 عيون مياه كبريتية ساخنة طبيعية، تصل درجة حرارتها إلى حوالي 37 درجة مئوية، وهي فعالة في علاج الأمراض الجلدية، الروماتيزم، وآلام العظام والمفاصل.' },
  ...
  { name: 'كهف الملح',      src: '/backgrounds/كهف الملح.png',       info: 'كهف ملح في سيوة، واللي بتُستخدم في العلاج بالملح، مفيدة للجهاز التنفسي، وبتقلل الحساسية، وكمان بتساعد في تحسين مشاكل الجلد. كمان الملح بيتستخدم جنب العلاج بالدفن في جبل الدكرور، وده بيزود تأثير العلاج، لأنه بيساعد الجسم يتخلص من السموم، ويحسّن الدورة الدموية، ويزود الإحساس بالراحة.' },
  { name: 'كهف الملح ١',    src: '/backgrounds/كهف الملح1.png',      info: 'كهف ملح في سيوة، واللي بتُستخدم في العلاج بالملح، مفيدة للجهاز التنفسي، وبتقلل الحساسية، وكمان بتساعد في تحسين مشاكل الجلد. كمان الملح بيتستخدم جنب العلاج بالدفن في جبل الدكرور، وده بيزود تأثير العلاج، لأنه بيساعد الجسم يتخلص من السموم، ويحسّن الدورة الدموية، ويزود الإحساس بالراحة.' },
  { name: 'كهف الملح ٢',    src: '/backgrounds/كهف الملح2.png',      info: 'كهف ملح في سيوة، واللي بتُستخدم في العلاج بالملح، مفيدة للجهاز التنفسي، وبتقلل الحساسية، وكمان بتساعد في تحسين مشاكل الجلد. كمان الملح بيتستخدم جنب العلاج بالدفن في جبل الدكرور، وده بيزود تأثير العلاج، لأنه بيساعد الجسم يتخلص من السموم، ويحسّن الدورة الدموية، ويزود الإحساس بالراحة.' },
  { name: 'وادي عسل',       src: '/backgrounds/وادي عسل .png',       info: 'بيساعد في تخفيف آلام المفاصل والروماتيزم، الطين الطبيعي فيه بيستخدم في تنظيف البشرة وتحسين شكلها، الجو الهادي بيساعد على تقليل التوتر والاسترخاء، بيساعد الجسم على الراحة وتحسين الحالة النفسية.' },
]
        ...
        {photoUrl && (
          <motion.div
            ...
            style={{
              ...
              padding: 'max(48px, env(safe-area-inset-top,48px)) 18px max(24px, env(safe-area-inset-bottom,24px))',
            }}
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
